                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <div class="mb-2 dropdown">
                                    <button class="p-0 btn" type="button" id="dropdownMenuButton" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                        <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="eye"
                                                class="mr-2 icon-sm"></i> <span class="">View</span></a>
                                        <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="edit-2"
                                                class="mr-2 icon-sm"></i> <span class="">Edit</span></a>
                                        <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="trash"
                                                class="mr-2 icon-sm"></i> <span class="">Delete</span></a>
                                        <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                data-feather="printer" class="mr-2 icon-sm"></i> <span
                                                class="">Print</span></a>
                                        <a class="dropdown-item d-flex align-items-center" href="#"><i
                                                data-feather="download" class="mr-2 icon-sm"></i> <span
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <div class="mb-2 dropdown">
                                    <button class="p-0 btn" type="button" id="dropdownMenuButton1" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                        <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                                    </button>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                ...
                                <div class="mb-2 dropdown">
                                    <button class="p-0 btn" type="button" id="dropdownMenuButton2" data-toggle="dropdown"
                                        aria-haspopup="true" aria-expanded="false">
                                        <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                                    </button>
            ...
            <div class="overflow-hidden card">
                <div class="card-body">
                    <div class="mb-4 d-flex justify-content-between align-items-baseline mb-md-3">
                        ...
                        <div class="dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton3" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="printer"
                                        class="mr-2 icon-sm"></i> <span class="">Print</span></a>
                                <a class="dropdown-item d-flex align-items-center" href="#"><i data-feather="download"
                                        class="mr-2 icon-sm"></i> <span class="">Download</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="mb-2 row align-items-start">
                        <div class="col-md-7">
                            <p class="mb-3 text-muted tx-13 mb-md-0">Revenue is the income that a business has from its
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between align-items-baseline">
                        ...
                        <div class="mb-2 dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton4" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
                    ...
                    <p class="mb-4 text-muted">Sales are activities related to selling or the number of goods or services
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between align-items-baseline">
                        ...
                        <div class="mb-2 dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton5" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between align-items-baseline">
                        ...
                        <div class="mb-2 dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton6" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
                    ...
                    <div class="d-flex flex-column">
                        <a href="#" class="pb-3 d-flex align-items-center border-bottom">
                            ...
                            <div class="w-100">
                                ...
                                <p class="text-muted tx-13">Hey! there I'm available{{asset('backend')}}.</p>
                            </div>
                        </a>
                        <a href="#" class="py-3 d-flex align-items-center border-bottom">
                            ...
                            <div class="w-100">
                                ...
                                <p class="text-muted tx-13">I've finished it! See you so{{asset('backend')}}</p>
                            </div>
                        </a>
                        <a href="#" class="py-3 d-flex align-items-center border-bottom">
                            <div class="mr-3">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-2 d-flex justify-content-between align-items-baseline">
                        ...
                        <div class="mb-2 dropdown">
                            <button class="p-0 btn" type="button" id="dropdownMenuButton7" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                                <i class="icon-lg text-muted pb-3px" data-feather="more-horizontal"></i>
                            </button>
